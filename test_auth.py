...
from recommender.config import SCOPES_TOP_READ

auth_manager = get_spotify_client(scopes=SCOPES_TOP_READ, cache_path=".cache-debug").auth_manager
...
sp = get_spotify_client(scopes=SCOPES_TOP_READ, cache_path=".cache-debug")
me = sp.me()
